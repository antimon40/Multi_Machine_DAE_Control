function [isJacobianmade] = getJacobianMatrix(case_sys)
...
if ~isfile(name_jacobian_m)
    ...
    %Redefine function
    fx = case_sys.F_P_Jac(Xs,Igs,Vgs,Vls,U);
...
% %Redefine base function
% function [out] = fx_base(X,Ig,Vg,Vl,U)
%     out = case_sys.F_P_Jac(X,Ig,Vg,Vl,U);
% end
